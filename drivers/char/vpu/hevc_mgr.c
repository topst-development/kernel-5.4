...
typedef int (*tccfp_hevc_dec_t)(int, codec_handle_t*, void*, void*);
tccfp_hevc_dec_t tcc_hevc_dec;

typedef struct st_hevc_func_t {
	int check_code1;
	int (*tccfp_hevc_dec)(int, codec_handle_t*, void*, void*);
	int check_code2;
	int (*tccfp_hevc_enc)(int, codec_handle_t *, void *, void *);
	int check_code3;
	int (*tccfp_hevc_dec_esc)(int, codec_handle_t *, void *, void *);
	int (*tccfp_hevc_dec_ext)(int, codec_handle_t *, void *, void *);
	int check_code4;
} st_hevc_func;
...
#	endif
	...
	filp = filp_open("/proc/hevc", O_CREAT | O_RDWR, 0644);
...
#	endif
	...
	V_DBG(VPU_DBG_INFO, "HEVC CheckCode %c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n",
	...
	if(ret == 0 &&
			((CHECK_CODE_01 | stHEVCFunc->check_code1) == CHECK_CODE_01) &&

...
//Decoder
typedef int (*tccfp_vpu_4k_d2_dec_t)(int, codec_handle_t*, void*, void*);
tccfp_vpu_4k_d2_dec_t tcc_vpu_4k_d2_dec;
typedef int (*tccfp_vpu_4k_d2_dec_esc_t)(int, codec_handle_t*, void*, void*);
tccfp_vpu_4k_d2_dec_esc_t tcc_vpu_4k_d2_dec_esc;
typedef int (*tccfp_vpu_4k_d2_dec_ext_t)(int, codec_handle_t*, void*, void*);
tccfp_vpu_4k_d2_dec_ext_t tcc_vpu_4k_d2_dec_ext;

typedef struct st_vpu_4k_d2_func_t {
	int check_code1;
	int (*tccfp_vpu_4k_d2_dec)(int, codec_handle_t*, void*, void*);
	int check_code2;
	int (*tccfp_vpu_4k_d2_enc)(int, codec_handle_t *, void *, void *);
	int check_code3;
	int (*tccfp_vpu_4k_d2_dec_esc)(int, codec_handle_t *, void *, void *);
	int (*tccfp_vpu_4k_d2_dec_ext)(int, codec_handle_t *, void *, void *);
	int check_code4;
} st_vpu_4k_d2_func;
...
#	endif
	...
	filp = filp_open("/proc/4kd2", O_CREAT | O_RDWR, 0644);
...
#	endif
	...
	if(ret == 0 &&
			((CHECK_CODE_01 | st4KD2Func->check_code1) == CHECK_CODE_01) &&
...
rinse_repeat:
		...
		case GET_INITIAL_INFO_FOR_STREAMING_MODE_ONLY_KERNEL:
		{
			...
			ret =
				...
				cmd & ~VPU_BASE_OP_KERNEL,
				(codec_handle_t *)&pHandle,
				(void *)(&arg->gsV4kd2DecInitialInfo),
				NULL);
		}
		break;
...
int vmgr_4k_d2_probe(struct platform_device *pdev)
{
	...
	dprintk("vmgr_4k_d2 initializing!!");

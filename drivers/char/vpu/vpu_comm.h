...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5,0,0) && !defined(CONFIG_CFI_CLANG)
...
#	define GET_FOURCC_1(a) (((__u32)a) & 0x00FF)
#	define GET_FOURCC_2(a) (((__u32)a >> 8) & 0x00FF)
#	define GET_FOURCC_3(a) (((__u32)a >> 16) & 0x00FF)
#	define GET_FOURCC_4(a) (((__u32)a >> 24) & 0x00FF)

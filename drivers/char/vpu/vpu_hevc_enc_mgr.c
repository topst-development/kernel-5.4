...
typedef int (*tccfp_vpu_hevc_dec_t)(int, codec_handle_t*, void*, void*);
tccfp_vpu_hevc_dec_t tcc_vpu_hevc_dec;
typedef int (*tccfp_vpu_hevc_enc_t)(int, codec_handle_t*, void*, void*);
tccfp_vpu_hevc_enc_t tcc_vpu_hevc_enc;
typedef int (*tccfp_vpu_hevc_enc_esc_t)(int, codec_handle_t*, void*, void*);
tccfp_vpu_hevc_enc_esc_t tcc_vpu_hevc_enc_esc;
typedef int (*tccfp_vpu_hevc_enc_ext_t)(int, codec_handle_t*, void*, void*);
tccfp_vpu_hevc_enc_ext_t tcc_vpu_hevc_enc_ext;

typedef struct st_vpu_hevc_enc_func_t {
	int check_code1;
	int (*tccfp_vpu_hevc_dec)(int, codec_handle_t*, void*, void*);
	int check_code2;
	int (*tccfp_vpu_hevc_enc)(int, codec_handle_t *, void *, void *);
	int check_code3;
	int (*tccfp_vpu_hevc_enc_esc)(int, codec_handle_t *, void *, void *);
	int (*tccfp_vpu_hevc_enc_ext)(int, codec_handle_t *, void *, void *);
	int check_code4;
} st_vpu_hevc_func;

static st_vpu_hevc_func *stHENCFunc = NULL;
...
#	endif
	...
	filp = filp_open("/proc/hevc_enc", O_CREAT | O_RDWR, 0644);
...
#	endif
	...
	V_DBG(VPU_DBG_INFO, "HEVC Enc CheckCode %c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n",
	...
	if(ret == 0 &&
			((CHECK_CODE_01 | stHENCFunc->check_code1) == CHECK_CODE_01) &&

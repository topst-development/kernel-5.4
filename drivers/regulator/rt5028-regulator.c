...
static void rt5028_timer_func(struct timer_list *t)
{
	struct rt5028_data *rt5028 = from_timer(rt5028, t, timer);
...
//      }
	...
	timer_setup(&rt5028->timer, NULL, 0);
...
/* Module information */
MODULE_DESCRIPTION("Richtek RT5028 Regulator driver");

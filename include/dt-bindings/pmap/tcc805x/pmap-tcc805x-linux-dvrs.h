...
#include <dt-bindings/pmap/tcc805x/pmap-tcc805x-linux-dvrs-video.h>
...
#define	RESERVED_MEM_BASE		(0x80000000)
#define	RESERVED_MEM_SIZE		(0x40000000)

#define	PVR_VZ_BASE			(RESERVED_MEM_BASE)

#define	CAMERA_PGL_BASE			(PVR_VZ_BASE + PMAP_SIZE_PVR_VZ)
...
#define	SECURE_AREA_1_BASE		(CAMERA_PREVIEW7_BASE + PMAP_SIZE_CAMERA_PREVIEW7)

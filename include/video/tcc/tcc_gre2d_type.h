...
typedef struct {
	...
	G2D_OP_CHROMA csel0;  //operator 0 chroma-key source select 0:disable 1: src0 & S0_chroam 2:src1 & S1_chroma 3:reseved
	GE_ROP_TYPE op_mode0;  // operator 0 operation mode
...
typedef struct {
	...
	// operator 정의
	G2D_OP_CHROMA op_ctrl_scel0; // Chroma-key Source Select
